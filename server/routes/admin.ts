...
router.post('/users', authenticateToken, authorizeSuperAdmin, asyncHandler(async (req: Request, res: Response) => {
...
router.put('/users/:id', authenticateToken, authorizeSuperAdmin, asyncHandler(async (req: Request, res: Response) => {
    const { id } = req.params;
    const { username, password, email, role } = req.body;
...
router.delete('/users/:id', authenticateToken, authorizeSuperAdmin, asyncHandler(async (req: Request, res: Response) => {
    const { id } = req.params;
